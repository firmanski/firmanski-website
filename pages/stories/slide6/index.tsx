...
const Slide6: NextPageWithLayout = () => {
  const [xcors, setXcors] = useState();
  const [ycors, setYcors] = useState();
  const [type, setType] = useState("");
  const initialText = `I super excited with this programming language, I try to build a
    ...
    >
      <div className="w-96  h-auto overflow-hidden">
        <h1 className="text-4xl mb-7 font-riz-h leading-loose">
          👨‍💻Excited with programming stuff...
        </h1>
...
Slide6.getLayout = (page: ReactElement) => {
  return (
    <MainLayout>
